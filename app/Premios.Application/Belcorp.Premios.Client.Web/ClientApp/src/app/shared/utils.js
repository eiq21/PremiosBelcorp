...
exports.CustomRouterStateSerializer = CustomRouterStateSerializer;
...
var Constants = /** @class */ (function () {
    ...
    Constants.IdentityServer = (_a = /** @class */ (function () {
        ...
        _a.API_RESOURCE_AWARDS = "apiProtocols",
    ...
    Constants.ParametrosPremios = (_j = /** @class */ (function () {
        ...
        _j.ALTOBALDOSAS = 4,
        _j);
    Constants.TiposUrl = (_k = /** @class */ (function () {
            function class_10() {
            }
            return class_10;
        }()),
        _k.BANNER_INICIO = 1,
        _k.BANNER_INFORMACIONPREMIOS = 2,
        _k.BANNER_GANADORESANTERIORES = 3,
        _k.BANNER_MOVIL = 4,
        _k);
    return Constants;
}());
